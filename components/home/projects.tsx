...
const ProjectsSection = ({ isDesktop }: IDesktop) => {
  ...
  const renderSectionTitle = (): React.ReactNode => (
    ...
    >
      <p className="section-title-sm seq">FOUNDATION</p>
      <h1 className="section-heading seq mt-2">My Foundation</h1>
      <h2 className="text-2xl md:max-w-3xl w-full seq max-w-sm mt-2">
        I am currently in the foundation stage of my professional journey,
        dedicated to mastering core web technologies and building a solid
        technical base.
        <br />
        <br />
        Currently, I am a senior student majoring in Information System at Hanoi
        University of Industry (HaUI), which has provided me with a strong
        academic background in problem-solving and computer science
        fundamentals.
        <br />
        <br />
        My internship at GLOBALDEV VIETNAM (January - April 2026) served as a
        vital cornerstone, allowing me to apply my academic learnings to
  ...
  return (
    ...
    >
      {renderSectionTitle()}
      <div className={PROJECT_STYLES.PROJECTS_WRAPPER}></div>
    </section>
  );
};
