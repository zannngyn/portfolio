...
const AboutSection = () => {
  ...
  const renderQuotes = (): React.ReactNode => (
    <h1 ref={quoteRef} className="font-medium text-3xl sm:text-4xl md:text-6xl">
      ...
      >
        I am currently focused on building a rock-solid foundation in web
        development.{" "}
      </span>
      <span
      ...
      >
        My goal is to master core principles and modern architectures to create
        truly exceptional digital experiences.
      </span>
    </h1>
  );
